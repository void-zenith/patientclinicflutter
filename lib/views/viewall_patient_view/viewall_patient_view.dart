...
class ViewAllAPIController extends GetxController {
...
class ViewAllPatient extends StatelessWidget {
  ViewAllPatient({super.key});
  final ViewAllAPIController apiController = Get.put(ViewAllAPIController());
